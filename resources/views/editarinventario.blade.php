...
<div class="card border">
    <div class="card-body">
        ...
        <hr>
        <form action="/inventario/{{$inv->id}}" method="POST" enctype="multipart/form-data">
            ...
            <div class="row">
                ...
                <div class="col-md-6 text-left">
                    <div class="form-group">
                        ...
                        <input type="number" class="form-control {{ $errors->has('precoProduto') ? 'is-invalid' : '' }}" name="precoProduto" value="{{$inv->precoProduto}}" id="precoProduto" placeholder="Preço do produto">
